...
## Project Structure
    ...
    ├── testapiautodatamod_123481  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_123481`
...
2. Clone this repo and `cd testapiautodatamod_123481`
